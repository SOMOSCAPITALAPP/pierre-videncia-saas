...
export const premiumOffers: PremiumOffer[] = [
  ...
  },
  {
    ...
    label: "R$149,90",
    badge: "premium",
    text: "Tarô, numerologia, astrologia e orientação aprofundada dentro do chat.",
    maxQuestions: 5,
    durationMinutes: 90,
  ...
  },
  {
    ...
    label: "R$99,90",
    badge: "mensal",
    text: "Acompanhamento espiritual mensal com consultas conduzidas dentro da aplicação.",
    maxQuestions: 20,
